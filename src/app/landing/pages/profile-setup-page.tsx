...
/* Local Card replacement */
type CardProps = { children?: any; className?: string };
function Card({ children, className = "" }: CardProps) {
  return <div className={className}>{children}</div>;
}

/* Local Button replacement */
type LocalButtonProps = ButtonHTMLAttributes<HTMLButtonElement> & {
  variant?: "outline" | "default";
};
function Button({ variant, className = "", ...props }: LocalButtonProps) {
  const base =
    "inline-flex items-center px-4 py-2 rounded-md text-sm sm:text-base";
  const variantClass =
    variant === "outline"
      ? "bg-white border border-gray-300 text-gray-700 hover:bg-gray-50"
      : "";
...
export function ProfileSetupPage({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-pink-50 relative overflow-hidden">
      {/* Animated blobs */}
      <motion.div className="absolute top-20 right-10 w-64 sm:w-96 h-64 sm:h-96 bg-purple-300 rounded-full blur-xl opacity-20" />
      <motion.div className="absolute bottom-20 left-10 w-64 sm:w-96 h-64 sm:h-96 bg-blue-300 rounded-full blur-xl opacity-20" />
      ...
      <div className="container mx-auto px-4 sm:px-6 py-6 sm:py-8 relative z-10 max-w-4xl">
        ...
        <AnimatePresence mode="wait">
          {step === 1 && (
            <Card className="p-5 sm:p-8 rounded-3xl bg-white/80 shadow-2xl">
              <h2 className="text-xl sm:text-3xl mb-4 text-center bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">
                What are you interested in?
              </h2>
                ...
                {interests.map((interest) => {
                  ...
                  return (
                    ...
                    >
                      <div className="flex flex-col items-center gap-2">
                        <div
                          className={`w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br ${interest.gradient} flex items-center justify-center`}
                        >
          ...
          {step === 2 && (
            <Card className="p-5 sm:p-8 rounded-3xl bg-white/80 shadow-2xl">
              <h2 className="text-xl sm:text-3xl mb-6 text-center bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">
                What's your skill level?
              </h2>
                  ...
                  return (
                    ...
                    >
                      <div className="flex flex-col items-center gap-3 sm:gap-4">
                        <div
                          className={`w-12 h-12 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-br ${level.gradient} flex items-center justify-center`}
                        >
        ...
        {step === 3 && (
          <Card className="p-5 sm:p-8 rounded-3xl bg-white/80 shadow-2xl">
            ...
            <div className="grid gap-4">
              <input className="p-3 rounded-xl border text-sm sm:text-base" placeholder="Full Name" value={displayName} onChange={(e) => setDisplayName(e.target.value)} />
              <input className="p-3 rounded-xl border text-sm sm:text-base" placeholder="Profile Photo URL" value={photoURL} onChange={(e) => setPhotoURL(e.target.value)} />
              <input className="p-3 rounded-xl border text-sm sm:text-base" placeholder="College Name" value={college} onChange={(e) => setCollege(e.target.value)} />
              <input className="p-3 rounded-xl border text-sm sm:text-base" placeholder="Course (e.g. B.Tech CSE)" value={course} onChange={(e) => setCourse(e.target.value)} />
              <input className="p-3 rounded-xl border text-sm sm:text-base" placeholder="Student ID" value={studentId} onChange={(e) => setStudentId(e.target.value)} />
            </div>
          </Card>
        )}
