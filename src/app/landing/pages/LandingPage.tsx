  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <div className="pt-16 md:pt-20">
        ...
        <section
          id="about"
          className="py-12 sm:py-16 px-4 sm:px-6 bg-gradient-to-br from-purple-50 via-blue-50 to-pink-50"
        >
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-base sm:text-lg text-gray-700 max-w-3xl mb-8">
              Skill Share is a student collaboration platform that connects learners,
              mentors, and innovators across campus to share skills, solve problems,
              and grow together.
            </p>
            ...
            <div className="mt-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  ...
                  <div
                    key={index}
                    className="bg-white/80 backdrop-blur rounded-xl p-5 sm:p-4 text-center
                               shadow-md hover:shadow-xl hover:-translate-y-1
                               transition-all duration-300"
                  >
                    <div className="w-14 h-14 mx-auto mb-3 rounded-full
        ...
        >
          <div className="max-w-6xl mx-auto">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-10 sm:mb-12 text-center bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">
              How It Works
            </h2>
        ...
        <section id="features" className="py-12 sm:py-20 px-4 sm:px-6 bg-gray-50">
          <div className="max-w-6xl mx-auto">
            ...
            <ul className="list-disc ml-5 sm:ml-6 text-base sm:text-lg text-gray-700 space-y-2">
              <li>Skill matching</li>
              <li>Real-time chat</li>
              <li>Group collaboration</li>
              <li>Helpdesk Q&A</li>
        ...
        <section
          id="faq"
          className="py-12 sm:py-20 px-4 sm:px-6 bg-gradient-to-br from-purple-50 via-blue-50 to-pink-50"
        >
          <div className="max-w-4xl mx-auto">

            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-8 sm:mb-10 text-center bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">
              Frequently Asked Questions
            </h2>
            ...
            <div className="space-y-4">
              {faqs.map((faq, index) => (
                ...
                >
                  ...
                  {openFAQ === index && (
                    <div className="px-4 sm:px-6 pb-4 text-sm sm:text-base text-gray-600">
                      {faq.a}
                    </div>
                  )}
                </div>
        ...
        {/* ================= PRIVACY ================= */}
        <section id="privacy" className="py-12 sm:py-20 px-4 sm:px-6 bg-white">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6">
              Privacy Policy
            </h2>
