...
export function StatsSection() {
  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-br from-purple-600 via-blue-600 to-pink-600 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <motion.div
          ...
          onViewportEnter={() => setIsInView(true)}
        >
          <h2 className="text-2xl sm:text-3xl md:text-5xl mb-4 text-white">
            Making an Impact
          </h2>
          ...
          {stats.map((stat, index) => {
            ...
            return (
              <motion.div
                ...
                className="relative"
              >
                <div className="bg-white/10 backdrop-blur-lg rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 border border-white/20 shadow-xl hover:shadow-2xl transition-all duration-300">
                  
                  {/* Icon */}
                  <motion.div
                    className={`w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br ${stat.gradient} flex items-center justify-center mb-4 mx-auto`}
                    whileHover={{ rotate: 360 }}
                    transition={{ duration: 0.6 }}
                  >
                  ...
                  {/* Value */}
                  <div className="text-center">
                    <div className="text-xl sm:text-2xl md:text-4xl text-white mb-2">
                      {isInView && (
                        <StatCounter
                          target={stat.value}
                          suffix={stat.suffix}
