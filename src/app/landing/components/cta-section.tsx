...
function Button({ size, className = "", children, ...rest }: ButtonProps) {
  const sizeClasses =
    size === "lg"
      ? "text-base sm:text-lg py-4 px-6"
      : size === "sm"
      ? "text-sm py-1 px-3"
      : "text-base py-2 px-4";
...
export function CTASection({ onJoinClick }) {
  return (
    <section className="py-14 sm:py-20 bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 relative overflow-hidden">

      {/* Decorative elements */}
      <motion.div
        className="absolute top-10 right-10 w-48 sm:w-64 h-48 sm:h-64 bg-purple-300 rounded-full mix-blend-multiply filter blur-xl opacity-20"
        animate={{ scale: [1, 1.2, 1], rotate: [0, 90, 0] }}
        transition={{ duration: 10, repeat: Infinity, ease: "easeInOut" }}
      />

      <motion.div
        className="absolute bottom-10 left-10 w-48 sm:w-64 h-48 sm:h-64 bg-blue-300 rounded-full mix-blend-multiply filter blur-xl opacity-20"
        animate={{ scale: [1, 1.3, 1], rotate: [0, -90, 0] }}
        transition={{ duration: 12, repeat: Infinity, ease: "easeInOut" }}
      />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 items-center max-w-6xl mx-auto">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-600 via-blue-600 to-pink-600 bg-clip-text text-transparent leading-tight">
              Your Campus Community Awaits
            </h2>

            <p className="text-base sm:text-lg text-gray-700 mb-8">
              Don&apos;t learn alone. Join a vibrant community of curious minds,
              helpful peers, and collaborative spirits. Start building meaningful
              connections today.
            </p>
