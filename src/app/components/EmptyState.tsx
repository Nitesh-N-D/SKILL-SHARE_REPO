    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-yellow-400 rounded-full flex items-center justify-center shadow-lg">
          ...
          >
            <div className="w-9 h-9 sm:w-10 sm:h-10 bg-blue-500 rounded-full flex items-center justify-center shadow-lg">
        ...
        <div className="absolute inset-0 -z-10">
          <motion.div
            animate={{ x: [0, 20, 0], y: [0, -20, 0] }}
            transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
            className="absolute top-0 right-0 w-24 h-24 sm:w-32 sm:h-32 bg-purple-300 rounded-full blur-3xl opacity-30"
          />
          <motion.div
            animate={{ x: [0, -20, 0], y: [0, 20, 0] }}
            transition={{ duration: 5, repeat: Infinity, ease: "easeInOut" }}
            className="absolute bottom-0 left-0 w-28 h-28 sm:w-40 sm:h-40 bg-blue-300 rounded-full blur-3xl opacity-30"
          />
        </div>
      </motion.div>
