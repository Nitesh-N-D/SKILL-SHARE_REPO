...
// //         <ReplySection replies={replies} onReplySubmit={handleReplySubmit} />
// //       </DialogContent>
// //     </Dialog>
// //   );
// // }
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      >
        ...
        <DialogHeader>
          ...
          <div className="flex flex-wrap gap-x-4 gap-y-2 text-xs sm:text-sm text-gray-500 mt-2">
            <span className="flex items-center gap-1">
              <Clock className="size-4" />
              {question.timeAgo}
            </span>
        ...
        {/* ---------- CONTENT ---------- */}
        <p className="mt-4 text-sm sm:text-base whitespace-pre-wrap text-gray-800">
          {question.content}
        </p>
